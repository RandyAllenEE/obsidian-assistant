 ...
 */
export async function initializePresets(plugin: StatusBarManager, presetsContainer: HTMLDivElement, settingsContainer: HTMLDivElement) {
 ...
 * @param settingsContainer 
 */
async function addPreset(plugin: StatusBarManager, presetsContainer: HTMLDivElement, settingsContainer: HTMLDivElement) {
 ...
 * @param presetName 
 */
async function deletePreset(plugin: StatusBarManager, presetsContainer: HTMLDivElement, settingsContainer: HTMLDivElement, presetName: string) {
    ...
    if (getActivePreset(plugin) == presetName) {
        ...
        else setActivePreset(plugin, t("Default"));
    }
 ...
 * @returns 
 */
async function renamePreset(plugin: StatusBarManager, presetEntry: HTMLDivElement, nameField: HTMLInputElement, presetName: string) {
 ...
 */
async function selectPreset(plugin: StatusBarManager, presetEntry: HTMLDivElement, presetName: string, settingsContainer: HTMLDivElement) {
 ...
 */
export async function setActivePreset(plugin: StatusBarManager, presetName: string) {
    if (isFullscreen()) {
 ...
 */
export function getActivePreset(plugin: StatusBarManager) {
    if (isFullscreen()) {
